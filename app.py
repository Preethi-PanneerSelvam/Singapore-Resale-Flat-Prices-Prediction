...
def main():
    ...
    resale_year = st.sidebar.number_input('Enter the resale year', value=2016, min_value=lease_commence_year)
    resale_month = st.sidebar.number_input("Enter the resale month", value=12)
